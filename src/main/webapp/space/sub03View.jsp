...
function deletePost() {
    ...
    if (confirmed) {
    	...
    	//전송방식과 전송할경로를 지정한다. 
        form.method = "post";  
        form.action = "DeleteProcessFree.jsp";
...
%>
     <button type="button"
             onclick="location.href='sub03Edit.jsp?num=<%= dto.getNum() %>';" class="btn btn-outline-primary btn-sm">
         수정하기</button>
...
%>
                <button type="button" onclick="location.href='sub03List.jsp';" class="btn btn-outline-dark btn-sm">
                    목록 보기
                </button>
            </td>
        </tr>
