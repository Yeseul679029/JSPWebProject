...
%>					 
		...
		<li><a href="../center/sub07.jsp"><img src="../images/lnb06.gif" alt="MODIFY(회원정보수정)" /></a></li>
<%
}
%>
	...
	<map name="GNB">
		...
		<area shape="rect" alt="" title="" coords="428,0,529,33" href="../space/sub01List.jsp?tname=noticeboard" target="" />
		<area shape="rect" alt="" title="" coords="536,0,638,33" href="../community/sub01List.jsp?tname=empboard" target="" />
