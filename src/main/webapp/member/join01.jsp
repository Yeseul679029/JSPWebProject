...
function agreeCheck() {
	var agree = document.getElementById("agreement1");
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<!-- <form name="agreements" action="" onsubmit="return formMemAgree(this)"> -->
					...
					<p style="text-align:center; margin-bottom:20px;"><label><input type="checkbox" name="agreement1" value="" id="agreement1">이용약관과 개인정보취급방침에 동의합니다.</lable></p>
	
				<!--<p style="text-align:center; margin-bottom:20px"><input type="image" src="../images/btn01.gif" onclick="agreeCheck();"/></a>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p> -->
					<p style="text-align:center; margin-bottom:20px"><img src="../images/btn01.gif" onclick="agreeCheck();"/></a>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
				<!-- </form> -->
